...
ui <- dashboardPage(
    header = dashboardHeader(title = "Comparatif de banques avec des criteres socio-economiques",
                             ...
                             dropdownMenu(type = "messages",
                                          ...
                                          badgeStatus = NULL,
                                          headerText = "Mise à jour le 12/04/2022")),
        ...
        tabItems(
            ...
            tabItem("Map",
                    fluidRow(column(width=4,selectInput("choice",label="Choix de la representation : ",choices=c("Type","Banque"))),
                             column(width=4,selectInput("criteria",label="Choix du critere :", choices = c("Pas de critère",colnames(bdd_zese[-c(1,2,35)]))))),
            ...
            tabItem("Comparaison-Type",
                    fluidRow(column(width=12,selectInput("Critere", label = "Choix du critere",choices =c("Pas de critère",colnames(bdd_zese[-c(1,2,35)]))))),
                    fluidRow(column(width = 12,tags$div(style= "font-weight: 1000; font-family: Arial, monospace","Carte des banques cooperatives",tags$br()),plotlyOutput("carte_cooperative", width = "auto",height = "600px"),align="center"),
            ...
            tabItem("Comparaison-Banque",
                    fluidRow(column(width=12,selectInput("critere", label = "Choix du critere",choices = c("Pas de critère",colnames(bdd_zese[-c(1,2,35)]))))),
                    fluidRow(column(width=12,selectInput("Banque", label = "Choix des premieres banques : " ,choices = c("All",unique(bdd_coordonnees_banques2022$Banque)),multiple=TRUE)),
                             column(width=12,selectInput("Banqu", label = "Choix des deuxiemes banques : ",choices = c("All",unique(bdd_coordonnees_banques2022$Banque)),multiple=TRUE))),
                    actionButton("affiche","Afficher"),
                    fluidRow(column(width = 12,tags$div(style= "font-weight: 1000; font-family: Arial, monospace","Carte des premieres banques",tags$br()),plotlyOutput("carte_banque_1", width = "auto",height = "600px"),align="center"),
                             column(width = 12,tags$div(style= "font-weight: 1000; font-family: Arial, monospace","Carte des deuxiemes banques",tags$br()),plotlyOutput("carte_banque_2", width = "auto",height = "600px"),align="center"))),
            tabItem("Comparaison-Critere-Type",
                    ...
                    fluidRow(column(width=12,selectInput("Critere_1", label = "Choix du premier critere : ",choices = c("Pas de critère",colnames(bdd_zese[-c(1,2,35)])))),
                             column(width=12,selectInput("Critere_2", label = "Choix du deuxieme critere : ",choices = c("Pas de critère",colnames(bdd_zese[-c(1,2,35)]))))),
                    fluidRow(column(width = 12,tags$div(style= "font-weight: 1000; font-family: Arial, monospace","Carte du premier critere",tags$br(),tags$br()), plotlyOutput("carte_critere_type_1", width = "auto",height = "600px"),align="center"),
                             column(width = 12,tags$div(style= "font-weight: 1000; font-family: Arial, monospace","Carte du deuxieme critere",tags$br(),tags$br()),plotlyOutput("carte_critere_type_2", width = "auto",height = "600px"),align="center"))),
            tabItem("Comparaison-Critere-Banque",
                    fluidRow(column(width=12,selectInput("critere_1", label = "Choix du premier critere : ",choices = c("Pas de critère",colnames(bdd_zese[-c(1,2,35)])))),
                             column(width=12,selectInput("critere_2", label = "Choix du deuxieme critere : ",choices = c("Pas de critère",colnames(bdd_zese[-c(1,2,35)]))))),
                    fluidRow(column(width=12,selectInput("Banque_1", label = "Choix des premieres banques : ",choices = c("All",unique(bdd_coordonnees_banques2022$Banque)),multiple=TRUE)),
                             column(width=12,selectInput("Banque_2", label = "Choix des deuxiemes banques : ",choices = c("All",unique(bdd_coordonnees_banques2022$Banque)),multiple=TRUE))),
            ...
            tabItem("Criteres",
                    fluidRow(
                        column(4,selectInput("Criteres","Critere :",c("All",colnames(bdd_zese[-c(1,2,35)])),multiple = TRUE)),
